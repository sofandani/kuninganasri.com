 ...
 * the database class while being assets/db.php aware.
 * @ignore
 */
...
<link rel="stylesheet" href="../inc/css/buttons.css?ver=<?php echo preg_replace( '/[^0-9a-z\.-]/i', '', $wp_version ); ?>" type="text/css" />
