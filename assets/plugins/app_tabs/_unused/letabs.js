...
(function ($) {
	...
	defaults = {
		tabContainer : ".kuas-tabs_tab_container", // Element containing tab elements
		tabSelector : false,//"a", // Tab selector (eg. with href attribute for selecting specific content elements through ID)
		contentContainer : ".kuas-tabs_content_container", // Element containing content elements for tabs
		contentInner : ".kuas-tabs_content_inner", // Element containing content elements for tabs
	...
	function KuAsTabs(element, options) {
	...
	$.fn[pluginName] = function (options) {
		return this.each(function () {
			if (!$.data(this, 'plugin_' + pluginName)) {
				$.data(this, 'plugin_' + pluginName, new KuAsTabs(this, options));
			}
		});
	};
