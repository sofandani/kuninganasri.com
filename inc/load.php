 ...
 *
 * When WP_DEBUG_LOG is true, errors will be logged to assets/debug.log.
	...
	if ( !defined( 'WP_LANG_DIR' ) ) {
		if ( file_exists( WP_CONTENT_DIR . '/languages' ) && @is_dir( WP_CONTENT_DIR . '/languages' ) || !@is_dir(ABSPATH . WPINC . '/languages') ) {
			...
			if ( !defined( 'LANGDIR' ) ) {
				...
				define( 'LANGDIR', 'assets/languages' );
			}
		} else {
 ...
 *
 * If an object-cache.php file exists in the assets directory,
 ...
 *
 * The default directory is assets/mu-plugins. To change the default directory
 ...
 *
 * The default directory is assets/plugins. To change the default directory
...
function wp_load_translations_early() {
	...
	while ( true ) {
		...
		if ( @is_dir( ABSPATH . 'assets/languages' ) )
			$locations[] = ABSPATH . 'assets/languages';
