...
function wp_login_url($redirect = '', $force_reauth = false) {
	$login_url = site_url('masuk.php', 'login');
...
function wp_registration_url() {
	return apply_filters( 'register_url', site_url( 'masuk.php?action=register', 'login' ) );
}
...
function wp_login_form( $args = array() ) {
	...
	$form = '
		<form name="' . $args['form_id'] . '" id="' . $args['form_id'] . '" action="' . esc_url( site_url( 'masuk.php', 'login_post' ) ) . '" method="post">
...
function wp_lostpassword_url( $redirect = '' ) {
	...
	$lostpassword_url = add_query_arg( $args, network_site_url('masuk.php', 'login') );
